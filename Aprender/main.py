...
def principal():
    ...
    # Audios
    audio_clique = pygame.mixer.Sound('educacional/audios/principal/clique.ogg')

    # Imagens
    bmenu1 = pygame.image.load('educacional/imagens/principal/bmenu1.png')
    bmenu2 = pygame.image.load('educacional/imagens/principal/bmenu2.png')

    bmenu3 = pygame.image.load('educacional/imagens/principal/bmenu3.png')
    fundo = pygame.image.load('educacional/imagens/principal/educapy.jpeg')
...
def telajogos():
    ...
    # Imagens
    bjogo1 = pygame.image.load('educacional/imagens/principal/bjogo1.png')
    fundo = pygame.image.load('educacional/imagens/principal/tjogos.jpg')
...
def creditos():
    ...
    # Imagens
    fundo = pygame.image.load('educacional/imagens/principal/creditos.jpg')
    voltar = pygame.image.load('educacional/imagens/quiz/voltar.png')
    # Textos
    pygame.font.init()
    fonte2 = pygame.font.SysFont('Arial', 20)
...
def instrucoes():
    ...
    # Imagens
    fundo = pygame.image.load('educacional/imagens/principal/instrucoes.jpg')
    voltar = pygame.image.load('educacional/imagens/quiz/voltar.png')
    # Textos
    pygame.font.init()
    fonte2 = pygame.font.SysFont('Arial', 20)
